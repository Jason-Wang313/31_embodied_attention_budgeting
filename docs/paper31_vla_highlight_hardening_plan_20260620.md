# Paper31 VLA Highlight Hardening Plan

Date: 2026-06-20

## Objective

Make `C:/Users/wangz/Downloads/31.pdf` match the visible VLA-v4 role model's PDF link-box behavior while preserving the final 25-page embodied-attention paper:
...
- Canonical PDF: `C:/Users/wangz/Downloads/31.pdf`
- Pages: 25
- Size: 353,551 bytes
- SHA256: `88388E37C44F4B5EA946D4AA0F68843D83871D5EC972A8A017046E62F80194D2`
...
- The manuscript contains two internal `\ref` commands: `tab:main` and `tab:controls`.
...
4. Render the new link pages into `tmp/pdfs/paper31_after`.
...
8. Remove Paper31 temp renders, leaving only the shared role-model render directory.
9. Stage only Paper31 source and metadata files, commit, push, and verify a clean repository.
...
- Final PDF: `C:/Users/wangz/Downloads/31.pdf`
- Pages: 25
- Size: 405,172 bytes
